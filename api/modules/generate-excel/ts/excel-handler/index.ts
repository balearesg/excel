...
export class ExcelHandler {
    ...
    private _workbook: Excel.Workbook = new Excel.Workbook();
    ...
    async createExcel(params: IParamsExcel): Promise<IReturnHandler> {
        ...
        try {
            ...
            for (const sheet of sheetData) {
                ...
                const worksheet: Excel.Worksheet = this._workbook.addWorksheet(sheetName);
            ...
            await this._workbook.xlsx.writeFile(pathFile, options);
